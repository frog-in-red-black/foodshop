...
public class CourseApiServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/* page count order sort  courseName courseTypeId json 数据传送*/ 
		...
		//根据登录的userId(登录之后添加,暂时固定)
		int userId = 8;
		
		CourseModel courseModel = new CourseModel();
		ArrayList<CourseListDb> courseList = courseModel.getCourseByUserId(userId, startIndex, count, order, sort, courseName, courseTypeId);
